...
public class OneDayView extends BaseView {
     ...
     * @param mData
     */
    public void setDataToChart(final TimeDataManage mData) {
        this.mData = mData;
        ...
        if (landscape) {
            ...
            float left = CommonUtil.dip2px(mContext, pricewidth > volwidth ? pricewidth : volwidth);// TODO: 2018/11/9 左右边距为文字宽度
